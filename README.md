...
First-time user? Want to get going now? After downloading the program from the link above, this is probably what you want to do. Replace LINELOGIN with your LINE login name. 
